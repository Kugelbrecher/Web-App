...
const uploadImage = (publicId) => (req, res, next) => {
    console.log('uploadImage',publicId)
    return  multer().single('image')(req, res, () =>
...
function postImage(req, res) {
    ...
    res.send(`<img onload="window.parent.postMessage('${req.fileurl}','*')" width="200" height="200" src="${req.fileurl}">`);
}
